...
item = Item(user_id=1, name="Goggles", description="GogglesGogglesGogglesGogglesGoggles", catalog=catalog)
session.add(item)
session.commit()

item = Item(user_id=1, name="Snowboard", description="SnowboardSnowboardSnowboardSnowboard", catalog=catalog)
session.add(item)
session.commit()
